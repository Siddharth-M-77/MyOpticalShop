        ...
        <div className="relative py-24 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm px-6 py-3 rounded-full mb-8">
              ...
              <span className="text-white font-semibold">Established 2010</span>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-32">
          ...
          <div>
            ...
            <p className="text-gray-600 text-lg mb-6 leading-relaxed">
              ...
              world-class eye care services that are accessible, affordable, and
              personalized to each patient's unique needs. What began as a
        ...
        <div className="mb-32">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              A timeline of growth, innovation, and unwavering commitment to eye
              care
            </p>
          </div>
        ...
        <div className="bg-gradient-to-br from-teal-600 to-blue-600 rounded-3xl p-12 lg:p-16 text-center text-white shadow-2xl">
          ...
          <p className="text-xl text-teal-50 mb-8 max-w-2xl mx-auto">
            Join thousands of satisfied patients who trust VisionCare for their
            eye health needs
          </p>
          <button className="bg-white text-teal-600 px-10 py-4 rounded-xl font-semibold hover:shadow-xl transform hover:scale-105 transition-all text-lg">
