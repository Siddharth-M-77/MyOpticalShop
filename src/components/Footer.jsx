    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Premium eyewear and expert eye care services for a clearer
              tomorrow.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>
                <a href="/products" className="hover:text-teal-400 transition">
                  Shop Products
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li>
                <a href="/shipping" className="hover:text-teal-400 transition">
                  Shipping Info
                </a>
              </li>
              <li>
                <a href="/returns" className="hover:text-teal-400 transition">
                  Returns
                </a>
              </li>
              <li>
                <a href="/warranty" className="hover:text-teal-400 transition">
                  Warranty
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              <li className="flex items-start gap-2">
                ...
                <div>
                  <div>+91 7309759015</div>
                  <div className="text-sm">Mon-Sun, 9AM-8PM</div>
                </div>
              </li>
              <li className="flex items-start gap-2">
                <Mail className="h-5 w-5 text-teal-400 mt-0.5" />
                <div>info@maddhehsiyaeyeoptical.in</div>
              </li>
              <li className="flex items-start gap-2">
        ...
        <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
          <p>
            &copy; 2025 MaddheshiyaEyeCare. All rights reserved. Designed with
